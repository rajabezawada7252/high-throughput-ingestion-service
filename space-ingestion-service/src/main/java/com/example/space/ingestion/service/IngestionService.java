...
import secondarymodel.MinuteStatsSecondaryDBTable;
import secondaryrepository.SecondaryRepository;
...
public class IngestionService {
	 ...
	 */
	//@CircuitBreaker(name="externalService" ,fallbac)
	...
	public void callExternal(String endpoint) {
		webClient.get()
		.uri(endpoint)
		.retrieve()
		.toBodilessEntity()
    ...
    public void fallbackResponse(String endpoint, Exception ex) {
        System.out.println("External API failed. Fallback executed.");
    }
	...
	/*
	 * Adding two data sources in application
	 * @Transactional(transactionManager = "secondaryTransactionManager") public
	 * void saveStats(MinuteStats stats) { MinuteStatsRepository.save(stats); }
	 * 
	 * @Transactional(transactionManager = "secondaryTransactionManager") public
	 * void saveAudit(MinuteStatsSecondaryDBTable log) {
	 * SecondaryRepository.save(log); }
	 */
}
